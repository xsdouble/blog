<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:103:"D:\20170717workspace\UPUPW\UPUPW_NP7.0\htdocs\project\public/../application/admin\view\article\add.html";i:1503723967;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form class="form-horizontal" role="form" action="<?php echo url('Article/add'); ?>" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img src="" alt="" class="putImg" width="200">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title"
