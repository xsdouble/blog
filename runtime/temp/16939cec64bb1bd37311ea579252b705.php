<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:104:"D:\20170717workspace\UPUPW\UPUPW_NP7.0\htdocs\project\public/../application/admin\view\article\edit.html";i:1503724664;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">新增文章信息</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Article/edit',['id'=>$data['id']]); ?>" enctype="multipart/form-data" method="post">
                                        <div class="form-group">
                                            <label for="title"
                                                   class="col-sm-2 control-label no-padding-right">标题名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title"
                                                       value="<?php echo $data['title']; ?>" required="" type="text" >
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid" style="width: 100%;">
                                                    ...
                                                    <option value="<?php echo $v['id']; ?>" <?php if($data['cateid'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo $v['catename']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <p class="help-block col-sm-4 red">* 单词之间用空格隔开</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="keywords"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author" placeholder=""
                                                       name="author" type="text" required="" value="<?php echo $data['author']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" name="file" class="put form-control" value="<?php echo $data['pic']; ?>">
                                                <img src="<?php echo $data['pic']; ?>" alt="" width="200" class="putImg">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="title"
